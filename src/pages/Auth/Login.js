    ...
    <div className="content">
      <form className="form-horizontal">
        ...
        <div className="form-group">
          ...
          <div className="col-md-9 checkbox-group">
            <Field name="a" type="checkbox" label="a" component={renderField} />
            <Field name="b" type="checkbox" label="b" component={renderField} />
            <Field name="c" type="checkbox" label="c" component={renderField} />
          </div>
        </div>
